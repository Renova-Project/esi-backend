    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_validated', models.BooleanField(default=False)),
                ('event_file', models.FileField(blank=True, null=True, upload_to='school/events/files')),
                ('event_maker', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Competition',
